...
CastApiBootstrap.MR_EXTENSION_IDS_ = ["ekpaaapppgpmolpcldedioblbkmijaca", "lhkfccafpkdlaodkicmokbmfapjadkij", "ibiljbkambkbohapfhoonkcpcikdglop", "fjhoaacokmgbjemoflkofnenfaiekifl"];
...
CastApiBootstrap.findInstalledExtension = function() {
  window.navigator.presentation && CastApiBootstrap.isClank_() ? CastApiBootstrap.appendScript_("//www.gstatic.com/eureka/clank/cast_sender.js") : CastApiBootstrap.findInstalledExtension_(function(extensionId) {
    if (extensionId) {
